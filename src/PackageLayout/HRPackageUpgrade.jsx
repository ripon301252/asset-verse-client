    ...
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="grid gap-6
        ...
        {packages.map((pkg) => (
          <div
            key={pkg._id}
            className="p-6 border border-gray-300 dark:border-gray-600 dark:bg-gray-800 rounded-xl shadow hover:shadow-lg transition-transform transform hover:-translate-y-1"
          >
            ...
            <button
              ...
              className="mt-4 w-full bg-indigo-600 hover:bg-indigo-700 text-white py-2 rounded-lg font-medium transition-colors cursor-pointer"
            >
              Upgrade
            </button>
          </div>
